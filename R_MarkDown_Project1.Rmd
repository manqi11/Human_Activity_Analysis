...
```{r, echo=TRUE}
setwd("/Users/pzhou5/Dropbox/Coursera/05 Reproducable Data/Week2")
...
# A different way to plot, but it's not the same output style as the plot above
#ggplot(data=Weekday_Data,aes(x=interval,y=average_steps,color=weekday))+
#        facet_grid(. ~weekday)+
#        geom_line()+
#        xlab("5-minute Time Interval")+ylab("Averaged Steps across all Days") 
```
